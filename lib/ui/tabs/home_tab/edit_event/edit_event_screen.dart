                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemCount: viewModel.eventListProvider.categoryEventsNameList.length,
                        itemBuilder: (context, index) {
                          return GestureDetector(
                            onTap: () {
                              ...
                              viewModel.selectedImage =
                              viewModel.eventListProvider.eventImagesList[index];
                              viewModel.selectedEvent =
                              viewModel.eventListProvider.categoryEventsNameList[index];
                            ...
                            child: TabEventItem(
                              ...
                              isSelected: viewModel.eventListProvider.selectedIndex == index,
                              eventName:
                              viewModel.eventListProvider.categoryEventsNameList[index],
                              eventIconPath:
                              viewModel.eventListProvider.categoryEventsIconList[index],
                            ),
                          );
                        },
                      ),
                    ...
                    Form(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.stretch,
                        children: [
                          Text(AppLocalizations.of(context)!.title, style: AppStyle.semi16Black),
                          ...
                          const SizedBox(height: 16),
                          Text(AppLocalizations.of(context)!.description, style: AppStyle.semi16Black),
                          const SizedBox(height: 16),
                          CustomTextField(
